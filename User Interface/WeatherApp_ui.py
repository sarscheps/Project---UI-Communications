...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.fullSideBarWidget = QtWidgets.QWidget(parent=self.centralwidget)
        self.fullSideBarWidget.setObjectName("fullSideBarWidget")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.fullSideBarWidget)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.pushButton = QtWidgets.QPushButton(parent=self.fullSideBarWidget)
        ...
        self.smallSideBarWidget = QtWidgets.QWidget(parent=self.fullSideBarWidget)
        self.smallSideBarWidget.setObjectName("smallSideBarWidget")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.smallSideBarWidget)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout()
        self.verticalLayout_3.setSpacing(0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.homePageIconBtn = QtWidgets.QPushButton(parent=self.smallSideBarWidget)
        ...
        self.displayModeIconBtn = QtWidgets.QPushButton(parent=self.smallSideBarWidget)
        ...
        self.syncWithDeviceIconBtn = QtWidgets.QPushButton(parent=self.smallSideBarWidget)
        ...
        self.searchByAreaIconBtn = QtWidgets.QPushButton(parent=self.smallSideBarWidget)
        ...
        self.savedLocationsIconBtn = QtWidgets.QPushButton(parent=self.smallSideBarWidget)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(parent=self.smallSideBarWidget)
        ...
        self.verticalLayout_8.addWidget(self.smallSideBarWidget)
        self.gridLayout.addWidget(self.fullSideBarWidget, 0, 0, 1, 1)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("c:\\Users\\Public\\Documents\\GitHub\\Project---UI-Communications\\User Interface\\icons/BasicIcons/profileImage_logo.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(20, 5, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Preferred)
        ...
        self.humidityVLayout.addItem(spacerItem8)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(20, 150, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.pushButton.toggled['bool'].connect(self.smallSideBarWidget.setVisible) # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.homePageBtn.setText(_translate("MainWindow", "Home Page i"))
